...
class Constants:
    def __init__(self):
        self.SPECIFIC_HEAT_OF_CONSTANT_PRESSURE=20.79
        self.SPECIFIC_HEAT_OF_CONSTANT_VOLUME = 12.47
        self.IDEAL_GAS_LAW_CONSTANT = 8.314
Constants= Constants()
if __name__ == '__main__':
    number_of_moles = 390
    initialPressure = 2.25 * (10 ** 5)
    initialVolume = 4.8
    secondPressure = 5.25 * (10 ** 5)
    secondVolume = 11.8
    thirdPressure = initialPressure
    thirdVolume = initialVolume
